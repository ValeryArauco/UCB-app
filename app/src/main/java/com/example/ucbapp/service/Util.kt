package com.example.ucbapp.service
...
class Util {
    companion object {
        ...
        private fun showNotification(context: Context) {
            ...
            val notification =
                NotificationCompat
                    .Builder(context, "default_channel")
                    .setContentTitle("Progreso pendiente")
                    .setContentText("Aún te faltan elementos de competencia por completar. ¡No los dejes atrás!")
